...
public class BaseTellerReadPlatformServiceImpl implements BaseTellerReadPlatformService {
  ...
  public BaseTellerOpeningReceiptData retrieveOpeningReceipt(final String receiptNumber) {
    ...
    final List<BaseTellerOpeningReceiptData> receipts =
        namedParameterJdbcTemplate.query(
            receiptSql() + " WHERE o.receipt_number = :receiptNumber",
            params,
            new ReceiptMapper(this::denominations));
    if (receipts.isEmpty()) {
  ...
  private List<BaseTellerDenominationData> denominations(final Long openingId) {
    return namedParameterJdbcTemplate.query(
  ...
  private static final class ReceiptMapper implements RowMapper<BaseTellerOpeningReceiptData> {
